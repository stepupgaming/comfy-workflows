...
const llms = [
  ...
  "- `inspect` / `init` / `run` never install Python. This SDK does not install custom nodes. Missing packs install with `comfy node install <registry-id>` only when the user asks.",
